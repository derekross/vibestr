...
// Hard-coded community ID for Vibestr
export const VIBE_CODERS_COMMUNITY_ID = "34550:3f770d65d3a764a9c5cb503ae123e62ec7598ad035d836e2a810f3877a745b24:vibe-coding-mcigj8zi";
...
export function createCommunityPostTags(communityId: string, relay?: string): string[][] {
  ...
  // Add vibe-coding topic tag for filtering (optional but recommended)
  tags.push(['t', 'vibe-coding']);
