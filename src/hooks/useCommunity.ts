 ...
 */
export function useCommunity(communityId: string = VIBE_CODERS_COMMUNITY_ID) {
...
/**
 * Hook to get the Vibestr community specifically
 */
export function useVibeCodersCommunity() {
  return useCommunity(VIBE_CODERS_COMMUNITY_ID);
}